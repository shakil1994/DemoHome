...
public class KitchenRoomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_kichen_room, container, false);

        /********************************/
         /*    Define all the buttons    */
        /********************************/
        ToggleButton led1 = (ToggleButton) view.findViewById(R.id.toggleButtonLightKitchen);
        ToggleButton led2 = (ToggleButton) view.findViewById(R.id.toggleButtonFanKitchen);
